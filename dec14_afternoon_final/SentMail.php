...
<?php
	$email=$_SESSION['email'].'@clemson.edu';
	$ql1="select count(*) from messages where sendto='$email' AND bit='no' and flag='1'";
	$resul1=mysql_query($ql1);
	$rowl2=mysql_fetch_array($resul1);
?>
<p align="center"><a href="SpamMail.php">Spam Mail(<?php echo $rowl2['count(*)']; ?>)</a></p> 
</td>
<td>
...
{ 	
 echo $_POST['keyword'];
 $srch="Location:http://pba.cs.clemson.edu/~f09t10/Project/Milestone1/SentMail.php?".$_POST['keyword'];
 header($srch);
}
echo '<table border="1">';
echo '<b>To</b> &nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp <b>Subject</b> &nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp &nbsp <b>Date</b>&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp<b>Time </b>';
...
{	
	...
	?>	
	 <tr ><td width="350"><input type="checkbox" name="name[]" value="<?php echo $rows['message_id']; ?>">	<?php echo $row_num['fname']." ".$row_num['lname'];?> </td><td width="350"><a href='sent_message.php?<?php echo $rows['message_id']?>'><?php echo $rows['subject']?></a><?php if($rows['attachment'] != ''){ echo '<img src="attachment2.png" align="right" width="20" height="20">';} ?></td><td width="380"><?php echo $rows['t_timestamp'];?> </input></td></tr> 
<?php 	
	}
}
...
header('Location:http://pba.cs.clemson.edu/~f09t10/Project/Milestone1/SentMail.php');
}?>
