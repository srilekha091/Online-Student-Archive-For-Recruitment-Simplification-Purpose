...
{	
 echo $_POST['keyword'];
 $srch="Location:http://pba.cs.clemson.edu/~f09t10/Project/Milestone1/recruiter_SpamMail.php?".$_POST['keyword'];
 header($srch);
}
echo '<table border="1">';
...
{	
	...
	?>	
	  ...
	  echo '</b>'; ?> </td><td width="350"><a href='recruiter_spam_message.php?<?php echo $rows['message_id']?>'><?php echo $rows['subject']?></a><?php if($rows['attachment'] != ''){ echo '<img src="attachment2.png" align="right" width="20" height="20">'; } ?></td><td width="380"><?php echo $rows['t_timestamp'];?> </input></td></tr> 
<?php 
	if($rows['bit'] == 'yes')
	  echo '</b>';	
	}
