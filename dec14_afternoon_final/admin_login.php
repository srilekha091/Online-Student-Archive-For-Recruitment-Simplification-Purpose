...
if(isset($_POST['login']))
 {
        ...
        $pass=$_POST['pass'];
	   $queryy="select * from admin where username='$uname'";
       $resultt=mysql_query($queryy) or die(mysql_error());
       $row_num=mysql_fetch_row($resultt);
	   if($row_num[1] == $pass)
		{	      
		      $_SESSION['admin']=$row_num[2];
              header('Location: student_contacts_page.php');				
		}
  }
?>
...
<body>
<form method="post">
<u><b><center><h1>System Admin Login Page</h1></center></b></u>
<b><u>
