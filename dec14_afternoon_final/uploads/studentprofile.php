...
if(!(isset($_SESSION['email'])) && !(isset($_SESSION['disp'])) )
{
...
echo '<center><h1><u>'.$fname.'\'s Profile Page</u></h1>';
	echo '<table border=5 height=500> <tr >';
...
echo '<table border=7>';
echo '<tr>';
echo '<center><h2>'.$fname.'\'s Files</h2></center>';
...
echo '<b><td width=300><center><b><h3>Date Posted</h3></b></center></td></b>';
echo '</tr>';
