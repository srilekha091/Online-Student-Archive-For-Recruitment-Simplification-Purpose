...
elseif(strlen($cmid) <> '19' )
{
$flag=1;
echo '<br /><br />';
echo '<h3>Invalid Clemson e-mail id field!</h3>';
echo '<a href="students_registration.php">Take me back to student registration screen</a>';
echo '<br /><br />';
}
elseif($pwd == '')
 ...
 if($row_num[3] != NULL)
 {
  ...
  echo '<br /><br />';
	...
	$flag=1;
	   ...
	   $query="INSERT INTO student VALUES ('$fname','$lname','$cuid','$cmid','$pwd','$gender','$address1','$address2','$city','$country','$code','$contact','$major','$state','$activation_key','inactive','profiles/default_profile.jpg','-','$skill')";
